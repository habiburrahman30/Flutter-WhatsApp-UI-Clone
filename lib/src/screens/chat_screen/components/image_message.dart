...
import 'package:whatsapp_clone/src/models/chat_message.dart';
import 'package:whatsapp_clone/src/screens/chat_screen/components/image_preview.dart';
...
class ImageMessage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.all(kSmallPadding * 0.6),
      child: ImageBuilder(
        message: message,
        name: name,
      ),
