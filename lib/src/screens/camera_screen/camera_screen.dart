...
import 'package:whatsapp_clone/src/models/Images.dart';
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          //       top: kLargePadding * 15, right: kMedPadding),
          //   child: Align(
          ...
          Align(
            ...
            child: Padding(
              padding: const EdgeInsets.only(
                bottom: kLargePadding * 1.1,
                top: kLargePadding * 2.1,
                left: kLargePadding * 1.1,
                right: kLargePadding * 1.1,
              ),
              child: Row(
